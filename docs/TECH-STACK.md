...
| Cache | **Upstash Redis** + Next.js cache tags | cache แคตตาล็อก/หน้า CMS + ใช้เป็น keyspace ของระบบย่อลิงก์ |
...
| Link shortener | custom (Next.js route + Redis/Postgres) | URL สั้นสำหรับแชร์สินค้า/แคมเปญ + เก็บสถิติคลิก |
...
RESEND_API_KEY=
PROMPTPAY_ID=                    # เบอร์/เลขบัตร ปชช. ผู้รับเงิน
NEXT_PUBLIC_GA_ID=
NEXT_PUBLIC_GTM_ID=
